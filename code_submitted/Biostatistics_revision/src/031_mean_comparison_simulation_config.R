...
unit_projected_alternative_direction <- (
...
if (setting_id %in% c(
  ...
  treatment_minus_control_mean <- (
    5 * projected_null_mean_difference
  )
  ...
  treatment_minus_control_mean <- (
    projected_null_mean_difference +
      0.25 * unit_projected_alternative_direction
  )
} else {
  treatment_minus_control_mean <- (
    projected_null_mean_difference +
      2.00 * unit_projected_alternative_direction
  )
}
