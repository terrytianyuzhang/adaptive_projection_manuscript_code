...
\begin{revblock}
    The presented results is simulated using block-diagonal covariance matrices. In \Cref{app: additional simulation}, we provide additional results under unstructured sparse covariance matrices.
\end{revblock}
...
% introduce cov matrix struutre

% is the true PC sparse?

% introduce mean strcutre for null and alternative

% other important simulation details

% present the result

\subsection{Methods Details}
% describe how we estimatte the sparse matrix and get the PC
